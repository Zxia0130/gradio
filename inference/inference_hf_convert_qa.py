...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        if args.interactive:
            ...
            with open(r'/media/a6000/D/Workspace/ZX-GPT/show/QA_single/ask.txt', mode = 'r') as file:
                    ...
                    while True:
                        ...
                        if args.use_vllm:
                            ...
                            if args.with_prompt:
                                ...
                                response = output
                        test = '123'
                        # 打开一个txt文件，如果文件不存在会创建一个新文件
                        with open(r'/media/a6000/D/Workspace/ZX-GPT/ZX-GPT/Chinese-LLaMA-Alpaca-2-1/scripts/inference/output/out_put.txt', mode = 'a') as file:
                            # write_text = test
                            # 将输出文本写入文件
